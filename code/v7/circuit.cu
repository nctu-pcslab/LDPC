...
void CIRCUIT::DecodeMessage(){
    ...
    Timer.TimerStart();
        ...
        //UpdateLcx();
        //UpdateLcx_CPU();
        UpdateLcx_GPU<<<UCX_BLK,UCX_THD>>>(CudaData->d_Lxc, CudaData->d_NextLxcIndex, CudaData->d_LcxPosition, CudaData->d_Lcx, TotalEdge, CudaData->d_BlockBegin, CudaData->TotalBlock);
#ifdef PROFILE
    ...
    Timer.TimerStart();
        ...
        //UpdateLxc();
        //UpdateLxc_CPU();
        UpdateLxc_GPU<<<UXC_BLK,UXC_THD>>>(CudaData->d_Lcx, CudaData->d_NextLcxIndex, CudaData->d_LxcPosition, CudaData->d_Lxc, CudaData->d_Lint, TotalEdge, CudaData->d_BlockBeginUXC, CudaData->TotalBlockUXC);
#ifdef PROFILE
    ...
    Timer.TimerStart();
        ...
        Calculate_Posterior_GPU<<<POS_BLK,POS_THD>>>(CudaData->d_LcxSize, CudaData->d_Lcx, CudaData->d_LcxBegin, CudaData->d_Lint, CudaData->d_DecodedData, n_Total);
        //Debug();
#ifdef PROFILE
