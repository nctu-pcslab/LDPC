...
void CIRCUIT::DecodeMessage(){
    ...
    Timer.TimerStart();
        ...
        //UpdateLcx();
        //UpdateLcx_CPU();
        UpdateLcx_GPU<<<UCX_BLK,UCX_THD>>>(CudaData->d_LxcSize, CudaData->d_Lxc, CudaData->d_LxcBegin, CudaData->d_LcxPosition, CudaData->d_Lcx, k_Total);
#ifdef PROFILE
    ...
    Timer.TimerStart();
        ...
        //UpdateLxc();
        //UpdateLxc_CPU();
        UpdateLxc_GPU<<<UXC_BLK,UXC_THD>>>(CudaData->d_LcxSize, CudaData->d_Lcx, CudaData->d_LcxBegin, CudaData->d_LxcPosition, CudaData->d_Lxc, CudaData->d_Lint, n_Total);
#ifdef PROFILE
    ...
    Timer.TimerStart();
        ...
        Calculate_Posterior_GPU<<<UXC_BLK,UXC_THD>>>(CudaData->d_LcxSize, CudaData->d_Lcx, CudaData->d_LcxBegin, CudaData->d_Lint, CudaData->d_DecodedData, n_Total);
#ifdef PROFILE
