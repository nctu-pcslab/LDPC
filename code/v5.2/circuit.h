...
#ifdef DOUBLE
__global__ void UpdateLcx_GPU(int* d_LxcSize, double* d_Lxc, int* d_LxcBegin, int* h_LcxPosition, double* h_Lcx, int k_Total, int* d_LxcStripe);
...
#else
__global__ void UpdateLcx_GPU(int* d_LxcSize, float* d_Lxc, int* d_LxcBegin, int* h_LcxPosition, float* h_Lcx, int k_Total, int* d_LxcStripe);
